...
  * Filtros em dropdown: **Tipo** (*Todas, Receitas, Despesas*), **Categoria** e **Status** (*Pago, Pendente*).

  * Botão de ação `➕ Adicionar Lançamento`.

* **Tabela de Dados (Data Table):**

  * Colunas: `Data` | `Descrição` | `Categoria / Subcategoria` | `Tipo` | `Frequência` (*Pontual, Recorrente, Parcelado x/y*) | `Valor` | `Status` | `Ações`.
...
    * *Se Parcelado for selecionado:* Exibir campo numérico para "Quantidade de Parcelas".
...
Continue developing this project in the [Lovable editor](https://lovable.dev/projects/b0a067ab-4966-4fd1-852c-dbc31eb07d5e).
